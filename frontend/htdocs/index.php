...
<div class="container_full">
	...
	<div class="mobilebanner">
		<div class="container">
			...
			<p class="text"><?= wordwrap(strip_tags($content['content']),$wordwrap,'<br/>') ?></p>   
...
<div class="fresh_projects global_stats">
	...
	<div class="container">
        ...
        <div class="graph_options">
        	<a href="#" class="selected" data-option="1d">1d</a>
        	<a href="#" data-option="1w">1w</a>
	    ...
	    */ ?>
        <div class="graph_contain" style="text-align:left;">
			...
			<script type="text/javascript" src="./js/main.8827bbf9.js"></script>
        </div>
