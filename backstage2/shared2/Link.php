<?php
class Link {
	public static function url($url=false,$caption=false,$query_string=false,$variables=false,$get_query_persists=false,$target_elem_id=false,$class=false,$custom_animation=false,$window_target=false,$anchor=false,$disabled=false,$title=false) {
		global $CFG;
